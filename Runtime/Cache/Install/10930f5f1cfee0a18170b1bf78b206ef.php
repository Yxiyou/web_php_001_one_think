...
<html>
    <head>
        ...
        <link href="/onethink/Public/Install/css/install.css" rel="stylesheet">

        <!-- Le HTML5 shim, for IE6-8 support of HTML5 elements -->
        <!--[if lt IE 9]>
            <script src="assets/js/html5shiv.js"></script>
        <![endif]-->
        <script src="/onethink/Public/static/jquery-1.10.2.min.js"></script>
        <script src="/onethink/Public/static/bootstrap/js/bootstrap.js"></script>
    </head>
    ...
    <a class="btn btn-primary btn-large" href="/onethink/index.php?s=/admin">登录后台</a>
    <a class="btn btn-success btn-large" href="/onethink/index.php?s=/home">访问首页</a>
