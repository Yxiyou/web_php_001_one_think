...
<div id="main-container" class="container">
    ...
    <div class="span9">
        ...
        ================================================== -->
        <section id="contents">
            <?php $category=D('Category')->getChildrenId($category['id']);$__LIST__ = D('Document')->page(0,10)->lists($category, '`id` DESC', 1,true); if(is_array($__LIST__)): $i = 0; $__LIST__ = $__LIST__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><div class="">
                ...
                <div>
                    ...
                    <span>于 <?php echo (date('Y-m-d H:i',$list["create_time"])); ?></span> 发表在 
                    <span><a href=""><?php echo (get_category_title($list["category_id"])); ?></a></span>
