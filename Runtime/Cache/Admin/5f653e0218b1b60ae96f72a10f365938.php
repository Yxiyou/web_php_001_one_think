...
<body>
	...
	<form action="/onethink/index.php?s=/admin/channel/add/pid/0.html" method="post" class="form-horizontal">
		...
		<div class="form-item">
			...
			<div class="controls">
				<input type="text" class="text input-x" name="sort" value="<?php echo ((isset($info["sort"]) && ($info["sort"] !== ""))?($info["sort"]):'0'); ?>">
			</div>
		</div>
		<div class="form-item">
