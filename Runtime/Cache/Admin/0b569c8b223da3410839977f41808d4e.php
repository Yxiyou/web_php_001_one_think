...
<body>
    ...
    <tbody>
		<?php if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			...
			<td><a data-id="<?php echo ($vo["id"]); ?>" href="<?php echo U('Think/edit?model='.$vo['model_id'].'&id='.$vo['record_id']);?>"><?php echo get_action($vo['action_id'],'title');?></a></td>
			<td><?php echo get_nickname();?></td>
